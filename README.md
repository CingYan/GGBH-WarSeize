...
### 歷史記錄檔
MOD 運行時會直接在遊戲根目錄生成 `warhistory_{玩家ID}.json`，避免本地 MOD 與 Steam Workshop 安裝路徑差異：
```json
{
  "records": [
    {
...
- 🔍 新增從遊戲根目錄 `ModExportData/*/ModCode/dll/MOD_nV039M.dll` 反查真實 MOD DLL 目錄
- 🏷️ 內部 MOD log 版號更新為 `v27`
